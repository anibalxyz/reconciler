 ...
 *
 * <p>This class ensures a clean separation between the domain layer and the API layer by
 * transforming internal domain models into public-facing data structures. This prevents sensitive
 * information (like password hashes) from being exposed in API responses.
 *
...
public class UserMapper {
  ...
  /**
   * Maps a {@link User} domain object to a {@link UserDetailResponse} DTO. This response is
  ...
  /**
   * Maps a {@link User} domain object to a {@link UserCreateResponse} DTO. This response is used
