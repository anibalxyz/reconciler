 ...
 * JpaUserRepository}) to obtain the current, request-scoped {@code EntityManager} without having a
 * direct dependency on Javalin's {@code Context}. It relies on the {@link ContextProvider} to
 * access the context.
 *
