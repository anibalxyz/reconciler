 ...
 * JwtService}, and {@link RefreshTokenService} to provide secure authentication flows and enforces
 * the authentication time-window.
 *
...
public class AuthService {
   ...
   * InvalidCredentialsException} for both non-existent users and incorrect passwords. It also
   * enforces the time-window for authentication.
   *
   ...
   * @throws InvalidCredentialsException if the credentials are not valid or if the attempt is
   ...
   * user. It also enforces the time-window for authentication.
   *
   ...
   *     revoked, or if the attempt is outside the allowed time-window.
   */
