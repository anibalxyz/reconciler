...
public class JpaUserRepository implements UserRepository {
  ...
  /**
   * @return the persisted {@link User} domain object by using merge to handle both detached and new
   *     entities. Forces a flush to ensure ID and timestamp generation before returning.
   */
  @Override
  @SuppressWarnings("resource")
