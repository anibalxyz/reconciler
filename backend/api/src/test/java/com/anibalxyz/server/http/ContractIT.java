...
public class ContractIT extends IntegrationTest {
  ...
  public void ANY_users_id_invalidIdFormat_respond400() {
    ErrorMapperResult expectedResult = ExceptionsMapper.map(new InvalidIdFormat("abc"));
  ...
  public void ANY_users_id_nonExistingId_respond404(String method) {
    ...
    ErrorMapperResult expectedResult =
        FeaturesErrorMapper.map(UserNotFoundError.byId(nonExistingId));
  ...
  public void ANY_users_malformedJson_respond400(String method) {
    String malformedJson =
        """
                        ...
                        """;
    ErrorMapperResult expectedResult = ExceptionsMapper.map(new StreamReadException(""));
