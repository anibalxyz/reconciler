...
/**
 * Asserts every route declared by the application has explicit roles.
 *
 * <p>Plugin-owned paths, or paths that we can't assign a role are allowlisted;
 */
@DisplayName("Test that routes must declare explicit roles")
public class RoutesRolesIT extends IntegrationTest {

  private static final List<RouteExemption> EXEMPTED_ROUTES = List.of();
